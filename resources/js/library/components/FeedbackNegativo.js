...
export class FeedbackNegativo {
    constructor(
        scene,
        titulo = 'OPA! VAMOS TENTAR DE NOVO?',
        texto = 'LEIA O ENUNCIADO MAIS UMA VEZ E TENTE RESPONDER A QUESTAO NOVAMENTE.',
        callback = null,
        props = {}
    ) {
        ...
        this.props = props || {};
        this.buttonText = this.props.buttonText || 'VOLTAR';
    ...
    create() {
        ...
        // Unica diferenca: imagem de fundo da modal negativa
        this.imageBox = this.scene.add.image(1920 / 2, 1080 / 2, 'modalFeedbackNegativo').setOrigin(0.5, 0.5);
